...
const features = Array.from({ length: 4 }).map(function (x, i) {
  return {
    id: i,
        ...
        <Box w={'100vw'} h={'100vh'}>
          ...
          >
            ...
            <Text color={'gray.500'}>
              ...
              tempora ipsam cum a quos totam, beatae, similique ullam amet iusto
              quisquam maxime dolor aut accusantium!
            </Text>
            <Stack
              direction={'column'}
              spacing={3}
          ...
          <Box p={4}>
            <Container maxW={'7xl'} py={16} as={Stack} spacing={12}>
              <Stack spacing={0} align={'center'}>
                ...
                <Text>Check the latest jobs of the platform</Text>
              </Stack>
          ...
          <Box bg={useColorModeValue('gray.100', 'gray.700')} mt={2}>
            <Container maxW={'7xl'} py={16} as={Stack} spacing={12}>
              <Stack spacing={0} align={'center'}>
